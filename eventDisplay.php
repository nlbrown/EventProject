...
$eventName = "";
 ...
 try{
     ...
     require '../dbconnectserver.php';	 //host server
        ...
        $sql = "SELECT event_name, event_desc, event_presenter, event_time, event_date FROM wdv341_events";
...
<h2>All Current Events</h2>
    ...
    <span>Event Description:<strong> <?php echo $row[$idx]['event_desc']; ?></strong></span><br>
    <span>Event Presenter:<strong> <?php echo $row[$idx]['event_presenter']; ?></strong></span><br>
    <span>Event Date:<strong> <?php echo $row[$idx]['event_date']; ?></strong></span><br>
    <span>Event Time:<strong> <?php echo $row[$idx]['event_time']; ?></strong></span><br>
    </span>
        <?php
          $idx++;
        }  
